      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="w-full bg-gradient-to-br from-blue-50 to-white-lighter rounded-full h-2">
            <div className="bg-blue-600 h-2 rounded-full transition-all duration-300" style={{ width: '27%' }}></div>
          </div>
          <p className="text-gray-600 text-sm mt-2">Progression: 3 sur 11 étapes</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Card className="bg-gradient-to-br from-blue-50 to-white-light border-gray-200">
            <CardHeader 
              className="cursor-pointer hover:bg-gradient-to-br from-blue-50 to-white-lighter/30 transition-colors"
              onClick={() => toggleSection('revenus')}
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <DollarSign className="w-6 h-6 text-blue-600" />
                  <CardTitle className="text-gray-900">Revenus</CardTitle>
                </div>
                {openSection === 'revenus' ? (
            ...
            {openSection === 'revenus' && (
              <CardContent className="space-y-4">
                {/* Salaires */}
                <div>
                  <Label htmlFor="revenus_salaires" className="text-gray-700">Salaires nets annuels</Label>
                  <Input
                    id="revenus_salaires"
                    type="number"
                ...
                {/* BIC/BNC/BA */}
                <div>
                  <Label htmlFor="revenus_bic_bnc_ba" className="text-gray-700">BIC / BNC / BA (revenus professionnels)</Label>
                  <Input
                ...
                {/* Revenus fonciers */}
                <div className="space-y-3 p-4 bg-gradient-to-br from-blue-50 to-white/50 rounded-lg border border-gray-200">
                  <h4 className="font-semibold text-gray-900">Revenus fonciers</h4>
                  
                  <div>
                    <Label className="text-gray-700">Loyers bruts annuels</Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label className="text-gray-700">Charges déductibles</Label>
                    <Input
                      type="number"
                  ...
                  <div className="pt-2 border-t border-gray-200">
                    <Label className="text-gray-700">Revenus nets (calculé automatiquement)</Label>
                ...
                {/* Revenus mobiliers */}
                <div className="space-y-3 p-4 bg-gradient-to-br from-blue-50 to-white/50 rounded-lg border border-gray-200">
                  <h4 className="font-semibold text-gray-900">Revenus mobiliers</h4>
                  
                  <div>
                    <Label className="text-gray-700">Dividendes</Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label className="text-gray-700">Intérêts</Label>
                    <Input
                      type="number"
                  ...
                  <div className="pt-2 border-t border-gray-200">
                    <Label className="text-gray-700">Total (calculé automatiquement)</Label>
                    <div className="mt-1 p-2 bg-gradient-to-br from-blue-50 to-white-lighter rounded text-blue-600 font-semibold">
                ...
                {/* Plus-values */}
                <div className="space-y-3 p-4 bg-gradient-to-br from-blue-50 to-white/50 rounded-lg border border-gray-200">
                  <h4 className="font-semibold text-gray-900">Plus-values</h4>
                  
                  <div>
                    <Label className="text-gray-700">Plus-values mobilières</Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label className="text-gray-700">Plus-values immobilières</Label>
                    <Input
                      type="number"
          ...
          <Card className="bg-gradient-to-br from-blue-50 to-white-light border-gray-200">
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-gray-900">Charges déductibles</CardTitle>
                </div>
                {openSection === 'charges' ? (
                  <ChevronUp className="w-5 h-5 text-blue-600" />
                ) : (
            ...
            {openSection === 'charges' && (
              <CardContent className="space-y-4">
                <div>
                  <Label htmlFor="pensions_alimentaires" className="text-gray-700">Pensions alimentaires</Label>
                  <Input
                ...
                <div>
                  <Label htmlFor="dons_associations" className="text-gray-700">Dons aux associations</Label>
                  <Input
                ...
                <div>
                  <Label htmlFor="emploi_domicile" className="text-gray-700">Emploi à domicile</Label>
                  <Input
                    id="emploi_domicile"
                    type="number"
                ...
                <div className="space-y-3 p-4 bg-gradient-to-br from-blue-50 to-white/50 rounded-lg border border-gray-200">
                  <h4 className="font-semibold text-gray-900">Investissements défiscalisation</h4>
                  
                  <div>
                    <Label className="text-gray-700">Loi Pinel</Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label className="text-gray-700">Loi Malraux</Label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <Label className="text-gray-700">Loi Girardin</Label>
                    <Input
                      type="number"
          ...
          <Card className="bg-gradient-to-br from-blue-50 to-white-light border-gray-200">
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-gray-900">Fiscalité</CardTitle>
                </div>
            ...
            {openSection === 'fiscalite' && (
              <CardContent className="space-y-4">
                <div>
                  <Label htmlFor="tmi" className="text-gray-700 flex items-center gap-2">
                ...
                <div>
                  <Label htmlFor="ir_annee_precedente" className="text-gray-700">Impôt sur le revenu année précédente</Label>
                  <Input
                ...
                <div>
                  <Label htmlFor="ifi_du" className="text-gray-700">IFI dû (si applicable)</Label>
                  <Input
                    id="ifi_du"
                    type="number"
                ...
                <div>
                  <Label htmlFor="prelevements_sociaux" className="text-gray-700">Prélèvements sociaux</Label>
                  <Input
                ...
                <div>
                  <Label htmlFor="nombre_parts_fiscales" className="text-gray-700">Nombre de parts fiscales</Label>
                  <Input
