...
export default function BilanSuccessoralPage() {
  ...
  useEffect(() => {
    if (assessment.bilan_successoral) {
      setFormData(assessment.bilan_successoral)
    }
  }, [assessment.bilan_successoral])
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="w-full bg-gradient-to-br from-blue-50 to-white-lighter rounded-full h-2">
            <div className="bg-blue-600 h-2 rounded-full transition-all duration-300" style={{ width: '36%' }}></div>
          </div>
          <p className="text-gray-600 text-sm mt-2">Progression: 4 sur 11 étapes</p>
        </div>
        ...
        <Card className="bg-gradient-to-br from-blue-50 to-white-light border-gray-200">
          <CardHeader>
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-gray-900">Transmission et Succession</CardTitle>
            </div>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <Label htmlFor="testament_existe" className="text-gray-700">Avez-vous un testament ?</Label>
                  <Select
                    id="testament_existe"
                ...
                {showTestamentFields && (
                  <>
                    <div>
                      <Label htmlFor="type_testament" className="text-gray-700">Type de testament</Label>
                      <Select
                        id="type_testament"
                    ...
                    <div>
                      <Label htmlFor="date_testament" className="text-gray-700">Date du testament</Label>
                      <Input
                        id="date_testament"
                        type="date"
                    ...
                    <div>
                      <Label htmlFor="notaire" className="text-gray-700">Notaire (nom et coordonnées)</Label>
                      <Input
                        id="notaire"
                ...
                {formData.donations_realisees.length > 0 && (
                  <div className="space-y-3">
                    {formData.donations_realisees.map((donation) => (
                      <Card key={donation.id} className="bg-gradient-to-br from-blue-50 to-white border-gray-200">
                        <CardContent className="pt-4">
                          <div className="flex items-start gap-4">
                            <div className="flex-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                              ...
                              <div>
                                <Label className="text-gray-700 text-sm">Bénéficiaire</Label>
                                <Input
                              ...
                              <div>
                                <Label className="text-gray-700 text-sm">Abattement utilisé (€)</Label>
                                <Input
                                  type="number"
                ...
                {formData.assurances_vie_beneficiaires.length > 0 && (
                  <div className="space-y-3">
                    {formData.assurances_vie_beneficiaires.map((ben, index) => (
                      <Card key={index} className="bg-gradient-to-br from-blue-50 to-white border-gray-200">
                        <CardContent className="pt-4">
                          <div className="flex items-start gap-4">
                            <div className="flex-1 space-y-3">
                              <div>
                                <Label className="text-gray-700 text-sm">Contrat d'assurance-vie (ID)</Label>
                                <Input
                              ...
                              <div>
                                <Label className="text-gray-700 text-sm">Clause bénéficiaire</Label>
                                <Textarea
                              ...
                              <div>
                                <Label className="text-gray-700 text-sm">Type de clause</Label>
                                <Select
              ...
              <div className="space-y-4 pt-6 border-t border-gray-200">
                <h3 className="text-lg font-semibold text-gray-900">Objectifs de transmission</h3>
                
                <div>
                  <Label htmlFor="objectif_transmission" className="text-gray-700">Objectif principal</Label>
                  <Select
                ...
                <div>
                  <Label htmlFor="souhaits_particuliers" className="text-gray-700">Souhaits particuliers</Label>
                  <Textarea
