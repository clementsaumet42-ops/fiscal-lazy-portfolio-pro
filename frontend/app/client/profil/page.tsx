      ...
      <Card className="mt-8">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium mb-2">Nombre de parts fiscales</label>
                <Input
                  type="number"
                  required
                  min="1"
              ...
              <div>
                <label className="block text-sm font-medium mb-2">Revenu imposable annuel (€)</label>
                <Input
                  type="number"
                  required
                  min="0"
            ...
            <div>
              <label className="block text-sm font-medium mb-2">Patrimoine actuel (€)</label>
              <Input
                type="number"
                required
                min="0"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium mb-2">Objectif d'investissement</label>
                <Select
              ...
              <div>
                <label className="block text-sm font-medium mb-2">Horizon de placement (années)</label>
                <Input
                  type="number"
                  required
                  min="1"
