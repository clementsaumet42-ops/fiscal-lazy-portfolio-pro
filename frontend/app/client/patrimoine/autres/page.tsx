        ...
        <Card className="mb-6 bg-gradient-to-r from-gold/20 to-gold/10 border-gold">
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-cream/70 text-sm mb-1">Total Autres Actifs</p>
                <p className="text-4xl font-bold text-gold">{formatCurrency(totalAutresActifs)}</p>
              </div>
              <Gem className="w-16 h-16 text-gold/50" />
            </div>
          </CardContent>
        </Card>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-white">Cryptomonnaies ({formData.crypto_monnaies.length})</CardTitle>
                </div>
                <Button
                  type="button"
                  onClick={addCrypto}
              ...
              {formData.crypto_monnaies.length > 0 ? (
                <div className="space-y-3">
                  {formData.crypto_monnaies.map((crypto) => (
                    <Card key={crypto.id} className="bg-midnight border-midnight-lighter">
                      <CardContent className="pt-4">
                        <div className="flex items-start gap-4">
                          <div className="flex-1 grid grid-cols-1 md:grid-cols-4 gap-3">
                            <div>
                              <Label className="text-cream text-sm">Nom</Label>
                              <Input
                                value={crypto.nom}
                            ...
                            <div>
                              <Label className="text-cream text-sm">Quantité</Label>
                              <Input
                                type="number"
                                step="0.00000001"
                            ...
                            <div>
                              <Label className="text-cream text-sm">Valeur unitaire (€)</Label>
                              <Input
                                type="number"
                            ...
                            <div>
                              <Label className="text-cream text-sm">Valeur totale</Label>
                ...
                <p className="text-cream/50 text-center py-4">Aucune cryptomonnaie ajoutée</p>
              )}
            </CardContent>
          </Card>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-white">Métaux Précieux ({formData.metaux_precieux.length})</CardTitle>
                </div>
                <Button
                  type="button"
                  onClick={addMetal}
              ...
              {formData.metaux_precieux.length > 0 ? (
                <div className="space-y-3">
                  {formData.metaux_precieux.map((metal) => (
                    <Card key={metal.id} className="bg-midnight border-midnight-lighter">
                      <CardContent className="pt-4">
                        <div className="flex items-start gap-4">
                          <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-3">
                            ...
                            <div>
                              <Label className="text-cream text-sm">Quantité (grammes)</Label>
                              <Input
                                type="number"
                ...
                <p className="text-cream/50 text-center py-4">Aucun métal précieux ajouté</p>
              )}
            </CardContent>
          </Card>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-white">Œuvres d'Art ({formData.oeuvres_art.length})</CardTitle>
                </div>
                <Button
                  type="button"
                  onClick={addOeuvre}
              ...
              {formData.oeuvres_art.length > 0 ? (
                <div className="space-y-3">
                  {formData.oeuvres_art.map((oeuvre) => (
                    <Card key={oeuvre.id} className="bg-midnight border-midnight-lighter">
                      <CardContent className="pt-4">
                        <div className="flex items-start gap-4">
                          <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-3">
                            <div>
                              <Label className="text-cream text-sm">Description</Label>
                              <Input
                            ...
                            <div>
                              <Label className="text-cream text-sm">Valeur estimée (€)</Label>
                              <Input
                                type="number"
                            ...
                            <div>
                              <Label className="text-cream text-sm">Date d'acquisition</Label>
                              <Input
                                type="date"
                ...
                <p className="text-cream/50 text-center py-4">Aucune œuvre d'art ajoutée</p>
              )}
            </CardContent>
          </Card>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-white">Véhicules de Collection ({formData.vehicules_collection.length})</CardTitle>
                </div>
                <Button
                  type="button"
                  onClick={addVehicule}
              ...
              {formData.vehicules_collection.length > 0 ? (
                <div className="space-y-3">
                  {formData.vehicules_collection.map((vehicule) => (
                    <Card key={vehicule.id} className="bg-midnight border-midnight-lighter">
                      <CardContent className="pt-4">
                        <div className="flex items-start gap-4">
                          <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-3">
                            <div>
                              <Label className="text-cream text-sm">Modèle</Label>
                              <Input
                            ...
                            <div>
                              <Label className="text-cream text-sm">Année</Label>
                              <Input
                                type="number"
                ...
                <p className="text-cream/50 text-center py-4">Aucun véhicule de collection ajouté</p>
              )}
            </CardContent>
          </Card>
