        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <Card className="bg-midnight-light border-midnight-lighter">
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-cream/70 text-sm mb-1">Endettement Total</p>
                  <p className="text-2xl font-bold text-red-400">{formatCurrency(totalEndettement)}</p>
                </div>
                <DollarSign className="w-10 h-10 text-cream/30" />
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-midnight-light border-midnight-lighter">
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-cream/70 text-sm mb-1">Revenus Locatifs/An</p>
                  <p className="text-2xl font-bold text-green-400">{formatCurrency(totalRevenuLocatif)}</p>
                </div>
                <Building className="w-10 h-10 text-cream/30" />
              </div>
            </CardContent>
          </Card>
        </div>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-white">Biens Immobiliers ({assessment.biens_immobiliers.length})</CardTitle>
              </div>
              <Button
                ...
                <CardContent className="pt-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <Label className="text-cream">Type de bien *</Label>
                        <Select
                          value={formData.type}
                      ...
                      <div>
                        <Label className="text-cream">Adresse *</Label>
                        <Input
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <Label className="text-cream">Valeur vénale (€) *</Label>
                        <Input
                          type="number"
                    ...
                    <div className="pt-4 border-t border-midnight-lighter">
                      <div className="flex items-center justify-between mb-3">
                        <h5 className="font-semibold text-white">Crédit immobilier</h5>
                        <Button
                          type="button"
                          variant="outline"
                          size="sm"
                          ...
                          className={showPret ? "border-red-400 text-red-400" : "border-gold text-gold"}
                        >
                      ...
                      {showPret && (
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          <div>
                            <Label className="text-cream text-sm">Capital restant dû (€)</Label>
                            <Input
                              type="number"
                          ...
                          <div>
                            <Label className="text-cream text-sm">Mensualité (€)</Label>
                            <Input
                              type="number"
                    ...
                    {showRevenuLocatif && (
                      <div className="pt-4 border-t border-midnight-lighter">
                        <h5 className="font-semibold text-white mb-3">Revenus locatifs</h5>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          <div>
                            <Label className="text-cream text-sm">Loyers bruts annuels (€)</Label>
                            <Input
                              type="number"
                          ...
                          <div>
                            <Label className="text-cream text-sm">Charges déductibles annuelles (€)</Label>
                            <Input
                              type="number"
                          ...
                          <div>
                            <Label className="text-cream text-sm">Revenus nets annuels (calculé)</Label>
                    ...
                    {showSCPI && (
                      <div className="pt-4 border-t border-midnight-lighter">
                        <h5 className="font-semibold text-white mb-3">Détails SCPI</h5>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                          <div>
                            <Label className="text-cream text-sm">Nom SCPI</Label>
                            <Input
                          ...
                          <div>
                            <Label className="text-cream text-sm">Nombre de parts</Label>
                            <Input
                              type="number"
                          ...
                          <div>
                            <Label className="text-cream text-sm">Valeur de la part (€)</Label>
                            <Input
                              type="number"
                          ...
                          <div>
                            <Label className="text-cream text-sm">Rendement annuel (%)</Label>
                            <Input
                              type="number"
                              step="0.01"
            ...
            {assessment.biens_immobiliers.length > 0 ? (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {assessment.biens_immobiliers.map((bien) => (
                  <Card key={bien.id} className="bg-midnight border-midnight-lighter">
                    <CardContent className="pt-4">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            <Home className="w-5 h-5 text-gold" />
                            <span className="text-sm font-semibold text-gold">{bien.type}</span>
                          </div>
                          <p className="text-white font-medium">{bien.adresse}</p>
                          <p className="text-2xl font-bold text-gold mt-2">{formatCurrency(bien.valeur_venale)}</p>
                          {bien.pret && (
              ...
              <p className="text-cream/50 text-center py-8">Aucun bien immobilier ajouté</p>
            )}
          </CardContent>
        </Card>
